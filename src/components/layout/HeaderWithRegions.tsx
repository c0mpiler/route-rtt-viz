    ...
    <header className="bg-white shadow-md border-b border-gray-200">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex items-center justify-between mb-4 lg:mb-0">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-xl lg:text-2xl font-bold text-gray-900">Route Radar</h1>
              ...
              <>
                ...
                <div className="hidden lg:flex items-center gap-2">
                  <div className="flex items-center gap-1.5 px-3 py-1.5 bg-emerald-50 rounded-lg">
                    ...
                    <span className="font-medium text-emerald-800">{sourceRegion}</span>
                  </div>
                  ...
                  <div className="flex items-center gap-1.5 px-3 py-1.5 bg-rose-50 rounded-lg">
                    ...
                    <span className="font-medium text-rose-800">{targetRegion}</span>
                  </div>
                </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full p-6">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-xl font-semibold text-gray-900">Select Network Regions</h2>
              <button
      ...
      {showUploadModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full p-6">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-xl font-semibold text-gray-900">Import Network Data</h2>
              <button
