    ...
    <footer className="bg-white border-t border-secondary-200 mt-12">
      <div className="container mx-auto px-4 py-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-center text-secondary-600 text-sm mb-4 md:mb-0">
            Route Radar - Built by Harsha &copy; {currentYear}
          </p>
          <div className="flex space-x-4">
            ...
            <button
              ...
              className="text-secondary-600 hover:text-secondary-800 transition-colors duration-150 flex items-center"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5 mr-1"
